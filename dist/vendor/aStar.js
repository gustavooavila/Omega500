...
(function (Ω) {
  var astar = {
    ...
    search: function search(grid, start, end, diagonal, heuristic) {
      astar.init(grid);
      ...
      while (openHeap.size() > 0) {
        ...
        currentNode.closed = true; // Find all neighbors for the current node. Optionally find diagonal neighbors as well (false by default).
    ...
    neighbors: function neighbors(grid, node, diagonals) {
      var ret = [];
      var x = node.x;
      var y = node.y; // West
