...
var input = {
  ...
  bind: function bind(action, code) {
    var _this = this;
...
function bindMouse() {
  function setPos(e) {
    ...
    var relY = e.clientY - el.offsetTop;
    mouse.diff = {
      x: mouse.x - relX,
      y: mouse.y - relY
    };
...
function bindTouch() {
  function setPos(e) {
    var epos; // TODO: handle multitouch
    ...
    var relY = epos.clientY - el.offsetTop;
    touch.diff = {
      x: touch.x - relX,
      y: touch.y - relY
    };
