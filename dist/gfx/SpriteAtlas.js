...
(function (Ω) {
  ...
  var SpriteAtlas = Ω.Class.extend({
    ...
    initPList: function initPList(plist) {
      var self = this;
    ...
    loadImages: function loadImages(imageData) {
      var self = this;
    ...
    parseCSV: function parseCSV(csv, img) {
      var out = this.csv = {};
    ...
    parsePList: function parsePList(nodes) {
    ...
    render: function render(gfx, name, x, y) {
      if (this.plist) {
      ...
      gfx.ctx.drawImage(img, imgData.x, imgData.y, imgData.w, imgData.h, x, y, imgData.w, imgData.h);
    },
    renderPList: function renderPList(gfx, x, y) {
      ...
      var w = t[2];
      var h = t[3];
      gfx.ctx.drawImage(img, x1, x2, w, h, x, y, w, h);
    }
  });
