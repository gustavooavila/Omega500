...
(function (Ω) {
  ...
  */
  ...
  var Velocity = Ω.Trait.extend({
    makeArgs: function makeArgs(props) {
      return [props.friction];
    },
    init_trait: function init_trait(t, friction) {
      t.velX = 0;
      t.velY = 0;
      t.accX = 0;
      t.accY = 0;
      t.friction = friction || 0.75; // Overwrite the Entity base moveBy
  ...
  var Gravity = Ω.Trait.extend({
    ...
    init_trait: function init_trait(t) {
      t.velY = 0;
      t.accY = 0;
    },
    tick: function tick(t) {
  ...
  */
  ...
  var RemoveAfter = Ω.Trait.extend({
    ...
    init_trait: function init_trait(t, ticks) {
      t.ticks = ticks || 100;
    },
    tick: function tick(t) {
  ...
  */
  ...
  var Ticker = Ω.Trait.extend({
    ...
    init_trait: function init_trait(t, ticks, cb) {
      t.ticks = ticks || 100;
  ...
  */
  ...
  var Sin = Ω.Trait.extend({
    ...
    init_trait: function init_trait(t, speed, amp, target) {
      t.speed = speed || 100;
      t.amp = amp || 5;
      t.target = target || "yo";
      return t;
